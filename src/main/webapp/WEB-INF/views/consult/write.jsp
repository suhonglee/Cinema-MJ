	...
	<div class="contents-area">
		...
		<div class="write-wrapper">
			...
			<div class="write-title">
				<form:form modelAttribute="consult" id="fwrite"  action="${CONTEXT }/consult/" method="POST" onsubmit="return writeValid()">
					<div id="errors-div">
					...
					<div>
						...
						<form:input path="title" type="text" class="input-style" placeholder="제목을 입력하세요"/>
					</div>
					<form:textarea path="content"/>
					<div>
						<span class="write-label">작 성 자</span>
						<form:input type="text" path="writer" class="input-style" placeholder="이름"/>
					</div>
					<div>
						<span class="write-label">비밀번호</span> 
						<form:input type="password" path="password" class="input-style" placeholder="비밀번호"/>
					</div>
					<div>
						<span class="write-label">연락처</span> 
						<form:input type="text" path="tel" class="input-style" placeholder="010-0000-0000 형식으로 입력해주세요."/>
					</div>
					<div>
						<span class="write-label">이메일</span>
						<form:input type="text" path="email" class="input-style" placeholder="Email"/>
					</div>
					<div>
						<div class="foot-button">
							<div style="text-align:right">
								<input type="checkbox" name="secret" id="secret" checked/> 비밀글
							</div>
