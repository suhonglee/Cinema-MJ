		...
		<div class="contents-area">
			<div class="a-side">
				<div class="side-menu">
					...
					<ul>
						<li class="selected-menu"><a href="${CONTEXT}/company/">About Cinema M.J</a></li>
			...
			<div class="main-contents" >
				<img src="${CONTEXT}/resources/img/company/c_intro01.jpg" style="position: relative; left: 15%">
			</div>
		</div>
		<!-- FOOTER=======================================-->
