		...
		<div class="contents-area">
			<div class="a-side">
				<div class="side-menu">
					...
					<ul>
						<li ><a href="product">Process</a ></li>
						<li class="selected-menu"><a href="product_composition">Composition</a></li>
					</ul>
				</div>
			</div>
			<div class="main-contents">
				<img src="${CONTEXT}/resources/img/company/c_detail01_02.jpg" style="max-width:  1250px;">  
			</div>
		</div>
		<!-- FOOTER=======================================-->
