	...
	<div class="write-wrapper">
		<div class="write-header"><span></span></div>
			<div class="write-title">
				...
				<form:form modelAttribute="sample" method="${method }" action="${CONTEXT }/sample/${sample.no}" onsubmit="progress()">
					<div>
						<span>VIDEO</span>
						<form:input path="title" id="title" title="title" placeholder="비디오제목을 입력해주세요"/><form:errors path="title"/>
						<br/>
					</div>
					
					<div>
						<span>카테고리</span>
						<form:select path="category" style=" width: 599px;">
							<form:option value="1">WEDDING</form:option>
							<form:option value="2">BABY</form:option>
							<form:option value="3">PRODUCTION</form:option>
						</form:select>
					...
					<div>
						<span>비디오 ID</span>
						<form:input path="videoId" id="videoId" title="videoId" placeholder="VIMEO_ID: 숫자만 입력하세요"/><form:errors path="videoId" style="width: 599px;"/>
					</div>
					...
					<input class="adm-button btn-01" type="submit" value="확인" />
					<a  class="adm-button btn-02" href="${CONTEXT }/main">메인으로</a>
				</form:form>
			</div>
		</div>
	</div>
